...
export function Nav() {
  ...
  return (
    <aside className="w-56 bg-card border-r min-h-screen flex flex-col">
      <div className="p-4 border-b">
        <h1 className="font-bold text-lg">Kennion</h1>
        <p className="text-xs text-muted-foreground">AutoSales Platform</p>
      </div>
